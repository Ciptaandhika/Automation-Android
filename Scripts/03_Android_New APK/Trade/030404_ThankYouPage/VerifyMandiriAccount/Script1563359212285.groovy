...
Mobile.verifyElementExist(findTestObject('0304_Trade/030404_ThankYouPage/labelAccountNumberMandiri (1)'), GlobalVariable.Timeout)

Mobile.verifyElementExist(findTestObject('0304_Trade/030404_ThankYouPage/labelAtasNamaBankMandiri (1)'), GlobalVariable.Timeout)

Mobile.verifyElementExist(findTestObject('0304_Trade/030404_ThankYouPage/labelCabangBankMandiri'), GlobalVariable.Timeout)
