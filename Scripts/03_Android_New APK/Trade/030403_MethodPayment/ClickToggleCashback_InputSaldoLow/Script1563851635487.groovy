...
try 
{
	Mobile.tap(findTestObject('03_Android_New APK/Trade/030403_MethodPayment/switchCashbackXpath'), GlobalVariable.Timeout)
}

catch (Exception e)
{
	Mobile.tap(findTestObject('03_Android_New APK/Trade/030403_MethodPayment/switchCashback'), GlobalVariable.Timeout)
}
...
Mobile.setText(findTestObject('0304_Trade/030403_MethodPayment/txtBoxSaldoCashback'), GlobalVariable.BeratProdukTambahProduk, 
