...
lblDiskon = Mobile.getText(findTestObject('0305_Seller/030505_Produk/03050501_TambahProduk/txtBoxHargaDiskon'), GlobalVariable.Timeout)

assert lblDiskon == GlobalVariable.InputHargaDiskonFormatProdukTambahProduk
