...
lblHarga = Mobile.getText(findTestObject('0305_Seller/030505_Produk/03050501_TambahProduk/txtBoxHargaProduk'), GlobalVariable.Timeout)

assert lblHarga == GlobalVariable.InputHargaFormatProdukTambahProduk
