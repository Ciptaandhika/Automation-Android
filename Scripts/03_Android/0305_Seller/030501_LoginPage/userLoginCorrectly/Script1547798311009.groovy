...
'4.2  last step register seller will be displayed'
Mobile.verifyElementExist(findTestObject('0305_Seller/030503_Beranda/headerBeranda'), GlobalVariable.Timeout)
