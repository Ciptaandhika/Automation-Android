...
Mobile.verifyElementExist(findTestObject('0305_Seller/030501_LoginPage/txtBoxNamaTokoDSSI'), GlobalVariable.Timeout)

Mobile.setText(findTestObject('0305_Seller/030501_LoginPage/txtBoxNamaTokoDSSI'), GlobalVariable.NamaTokoDSSIMore30LoginPage, 
    GlobalVariable.Timeout)

Mobile.setText(findTestObject('0305_Seller/030501_LoginPage/txtBoxNamaTokoDSSI'), GlobalVariable.NamaTokoDSSILoginPage, 
    GlobalVariable.Timeout)

Mobile.setText(findTestObject('0305_Seller/030501_LoginPage/txtBoxNamaTokoDSSI'), '', GlobalVariable.Timeout)
