...
Mobile.verifyElementExist(findTestObject('0305_Seller/030501_LoginPage/txtBoxDomainTokoDSSI'), GlobalVariable.Timeout)

Mobile.setText(findTestObject('0305_Seller/030501_LoginPage/txtBoxDomainTokoDSSI'), GlobalVariable.UrlStoreDSSILoginPage, 
    GlobalVariable.Timeout)

Mobile.setText(findTestObject('0305_Seller/030501_LoginPage/txtBoxDomainTokoDSSI'), '', GlobalVariable.Timeout)
