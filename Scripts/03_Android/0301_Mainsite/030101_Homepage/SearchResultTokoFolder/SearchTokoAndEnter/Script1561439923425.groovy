...
Mobile.tap(findTestObject('0301_Mainsite/030105_SearchProduct/LabelLihatSemuaToko (1)'), GlobalVariable.Timeout)

Mobile.verifyElementExist(findTestObject('0301_Mainsite/030105_SearchProduct/TokoQASearch'), GlobalVariable.Timeout)
